 ...
 */
public class DepartmentAdministrationAdapter extends BaseAdapter{
    private Context context;
    private LayoutInflater inflater;

    public DepartmentAdministrationAdapter(Context context) {
        this.context = context;
        inflater=LayoutInflater.from(context);
    }
    private List<UserEntity>listOfUser=new ArrayList<UserEntity>();{
        listOfUser.add(new UserEntity("发布消息",R.drawable.next_item_icon));
        listOfUser.add(new UserEntity("提交文件",R.drawable.next_item_icon));
        listOfUser.add(new UserEntity("例会安排",R.drawable.next_item_icon));
        listOfUser.add(new UserEntity("内部通知",R.drawable.next_item_icon));
        listOfUser.add(new UserEntity("部门信息",R.drawable.next_item_icon));
    }
